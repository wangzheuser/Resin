...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "订阅管理": "Subscriptions",
  "导入 TXT": "Import TXT",
  "已导入 {{added}} 条，跳过 {{duplicates}} 条重复内容":
    "Imported {{added}} entries; skipped {{duplicates}} duplicates",
  "读取订阅文本文件失败": "Failed to read subscription text file",
  "正在加载订阅详情...": "Loading subscription details...",
  "正文较大，已折叠以保持页面流畅": "Large content is collapsed to keep the page responsive",
  ...
  "配置更新于 {{time}}": "Config updated {{time}}",
